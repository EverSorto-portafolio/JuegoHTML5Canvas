...
let x = 100;
let y = 100;
game.boing = game.canvas = document.getElementById("boing");
game.disparoSonido = game.canvas = document.getElementById("disparo");
game.sonidoGameOver = game.canvas = document.getElementById("fin");
game.sonidoIntro = game.canvas = document.getElementById("intro");
